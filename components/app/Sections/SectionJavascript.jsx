...
import javascriptStyles from "../../../static/jss/material-kit-react/views/componentsSections/javascriptStyles.jsx";
            ...
            <GridItem xs={12} sm={12} md={6}>
              ...
              <GridContainer>
                <GridItem xs={12} sm={12} md={6} lg={4}>
                  ...
                  >
                    <Icon className={classes.icon}>library_books</Icon>Classic
                  </Button>
                  <Dialog
                    classes={{
                      root: classes.center,
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Icon className={classes.modalClose}>close</Icon>
                      </IconButton>
