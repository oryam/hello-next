...
import basicsStyle from "../../../static/jss/material-kit-react/views/componentsSections/basicsStyle.jsx";
          ...
          <div id="buttons">
            ...
            <GridContainer justify="center">
              <GridItem xs={12} sm={12} md={8}>
                ...
                <Button color="primary" round>
                  <Icon className={classes.icons}>favorite</Icon> with icon
                </Button>
                <Button justIcon round color="primary">
                  <Icon className={classes.icons}>favorite</Icon>
                </Button>
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        ...
                        checkedIcon={<Icon className={classes.checkedIcon}>check</Icon>}
                        icon={<Icon className={classes.uncheckedIcon}>check</Icon>}
                  ...
                  <FormControlLabel
                    control={
                      <Radio
                        ...
                        checkedIcon={
                          <Icon className={classes.radioChecked}>fiber_manual_record</Icon>
                        }
                        classes={{
